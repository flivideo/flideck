        ...
        {isLoading ? (
          ...
          <div className="max-w-2xl mx-auto space-y-8">
            ...
            <section>
              ...
              >
                <code style={{ color: '#2E91FC' }} className="text-sm break-all">
                  {config.presentationsRoot}
                </code>
              </div>
            </section>
