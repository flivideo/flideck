...
**The Problem:**
Navigation between major pages (home/dashboard, presentation routes, presentations) feels clunky. The existing keyboard shortcuts work well _within_ a presentation (next/prev slide), but getting _between_ major areas needs improvement.
